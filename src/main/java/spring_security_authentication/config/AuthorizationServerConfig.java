...
//			.authorizedGrantTypes("implicit")  // 授權流程類型: 簡化模式
//			.authorizedGrantTypes("client_credentials")  // 授權流程類型: 客戶端模式
//			.authorizedGrantTypes("password")  // 授權流程類型: 客戶端模式
			.authorizedGrantTypes("password", "client_credentials", "implicit", "authorization_code", "refresh_token")  // 所有授權		
